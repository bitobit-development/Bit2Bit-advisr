...
'use client'
import { ROUTES, absolute } from '@/lib/routes';
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const generateQr = async () => {
      // const signupUrl = `${window.location.origin}/pre-wellness-day-reg/registration`
      const signupUrl = absolute(ROUTES.registration());
      try {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
        ...
        {isClient && (
         <a
           href={ABSOLUTE_URLS.registration()}
           target="_blank"
